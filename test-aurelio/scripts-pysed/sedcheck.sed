[line: s/\(_{*~\)\(.*\)/<trailing garbage after command (rest of the line 
ignored)>\2\1/]
[line: s/_a[^{~]*\({*~\)\\\(\\.*\)/\\<"\\" is not a valid delimiter>\2<missing 
delimiter>_\1/]
[line: s/^\([ 	]*[^ 	_][^_]*\)_c{\([^~]*~\)}/\1<"}" should be preceded by a 
'newline'>}_}\2/]
[line: s/_l\([^~]*~\)\('*[^']'*[^']'*[^']'*[^']'*[^']'*[^']'*[^']'*[^']\)\(..*\)/\2<
label more than 8 characters long>\3_\1/]
[line: s/_l\([^~]*~\)\(.*\)\([ 	][ 	]*\)$/\2<trailing 'blank's not 
recommended>\3_\1/]
[line: s/_c\([^~]*~\)\([sy]\)\(\\.*\)/\2<"\\" is not a valid delimiter>\3<missing 
delimiter>_\1/]
[line: s/_\(s\([1-9&]\)[^~]*~\)\\\2/<"\\\2" ambiguous with "\2" as delimiter
>\\\2_?\1/]
[line:   s/_[rR]\(\([n.(){1-9^$*[]\)[^~]*~\)\\\2/<"\\\2" ambiguous with "\2" as 
delimiter>_?r\1/]
[line:   s/_[rR]\([^~]*~\)\\(\^/\\(<subexpression anchoring is optional (use 
"\\^" instead)>^_?r\1/]
[line:   s/_[rR]\([^~]*~\)\(\\{[0-9][0-9]*,[0-9][0-9]*\)\([^\0-9]\)/\2<bad 
interval>\3_?r\1/]
[line:   s/_[rR]\([^~]*~\)\(\\{[0-9][0-9]*,[0-9][0-9]*\)\(\\[^}]\)/\2<bad 
interval>\3_?r\1/]
[line:   s/_[rR]\([^~]*~\)\(\$\\)\)/<subexpression anchoring is optional (use 
"\\$" instead)>\2_?r\1/]
[line:   s/_[rR]\([^~]*~\)\\$/<"\\'newline'" not allowed (use "\\n" 
instead)>\\_\\r\1/]
